        ...
        if (IsWindowsServer()) {
            ...
            if (IsWindows8OrGreater()) {
                ...
                if (hKernel32 && !GetProcAddress(hKernel32, "AddDllDirectory")) {
                    ...
                    BalLog(BOOTSTRAPPER_LOG_LEVEL_STANDARD, "Detected Windows Vista SP2");
                    return;
                }
            } else { 
                BalLog(BOOTSTRAPPER_LOG_LEVEL_ERROR, "Detected Windows Vista without SP2 or Windows XP or earlier");
